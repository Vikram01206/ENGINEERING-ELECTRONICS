    ...
    >
          ...
          <div className="flex items-center gap-2.5 mb-1.5">
            ...
            <div>
              <h1 className="text-white font-serif text-xl font-bold tracking-tight leading-none">
                ENGINEERING <span className="text-[#B40023]">ENTERPRISES</span>
              </h1>
      ...
      <div className="p-6 bg-slate-900 border-t border-slate-950">
        <div className="flex items-center space-x-3">
          ...
          <div className="min-w-0 flex-1">
            <p className="text-xs text-white font-semibold font-serif tracking-wide leading-tight">ENGINEERING ENTERPRISES</p>
